          ...
          <section class="content">
            ...
            <div class="box">
              <div class="box-header with-border">
                ...
                <div class="box-body" >
                  <!-- form start -->
                      <form role="form" method="post" name="agregar-inst-hor-rut" id="agregar-inst-hor-rut" action="insertar-admin.php">
                        <div class="box-body">
                                  ...
                                  <div class="form-group has-feedback">
                                    <label for="usuario">Rutinas con Horarios disponibles</label>
                                    <select name="rutin" id="rutin" required onchange="myplandetail1(this.value)" class="form-control">
                                    <option value="">--Please Select--</option>
                                    <?php
                      ...
                      <div class="box-footer">
                        <input type="hidden" name="agregar-inst-hor-rut" value="1">
