        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Tabla con los datos acerca de los Clientes</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="registros1" class="table table-bordered table-striped">
                ...
                <?php
                try{
                  $sql ="SELECT dnic,nombrec,apellidoc,correo,telefono FROM cliente where estado=1";
                ...
                <tr>
                  <td><?php echo $horario['dnic']; ?></td>
                  <td><?php echo $horario['nombrec']; ?></td>
                  <td><?php echo $horario['apellidoc']; ?></td>
                  <td><?php echo $horario['correo']; ?></td>
                  <td><?php echo $horario['telefono']; ?></td>
                  <td>
                    <button  class="btn bg-orange btn-flat margin btn-popup3" data-id=<?php echo $id?>>
                      <i class="fa fa-pencil"></i>Editar
                </button> 
                  </td>
                  <td>
                    <button  data-tipo="admin" class="btn bg-red btn-flat margin borrar-registro" data-id=<?php echo $id?>>
